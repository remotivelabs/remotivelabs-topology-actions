...
| [`publish-schemas`](publish-schemas/README.md) | Publish JSON schemas to a bucket at the path their `$id` names — immutable per version — and stage the same layout in a tarball for `sync-docs`. |
